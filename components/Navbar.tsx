...
const Navbar: React.FC = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-white/90 backdrop-blur-sm transition-all duration-300">
      {/* 
        Navbar compacte avec py-2 pour minimiser l'espace vertical
        et compenser la taille accrue du logo.
      */}
      <div className="w-full flex justify-between items-center py-2 px-6 md:px-10">
        ...
        <div className="z-50 flex items-center">
          ...
          >
            {/* 
              Logo agrandi (h-16 mobile, h-20 desktop)
              Object-fit contain pour préserver les proportions sans déformer
            */}
            <img 
        ...
        {/* Navigation: Alignée avec le logo, suppression de 'About' selon votre snippet */}
        ...
        {/* Mobile Menu Icon (3 Vertical Dots) */}
